    ...
    <div class="container-fluid">
      <form action="includes/register.inc.php" class="regf border" method="post">
        <div class="form-group">
          ...
          <input type="Username" <?php if (isset($_GET['uid'])) echo "value='".$_GET['uid']."'"?> required class="form-control" id="username" placeholder="Enter username" name="username">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="password" required class="form-control" id="pwdrpt" placeholder="Repeat password" name="pwdrpt">
        </div>
